# [2.0.0](https://github.com/PowerfulBacon/PurrNet/compare/v1.4.0...v2.0.0) (2025-09-15)


### Bug Fixes

* Fixes local module initialization order ([c2158c8](https://github.com/PowerfulBacon/PurrNet/commit/c2158c824f6af3ca7de05a387445df6d67b4cdcb))
* Fixes mistake ([12dc808](https://github.com/PowerfulBacon/PurrNet/commit/12dc808795b20dcf30f8e2c3b9060fad1b35f39f))
* Fixes network modules inside dynamic modules instantiating with the wrong ID ([0091816](https://github.com/PowerfulBacon/PurrNet/commit/00918162371d03fc73b49e7071f0651e50359a4b))
* Fixes queued RPC having no metadata ([f3858a4](https://github.com/PowerfulBacon/PurrNet/commit/f3858a40de52d4fa0be52bb6835c2e82d21ffde7))
* Fixes SyncVar double initialization ([c116ee7](https://github.com/PowerfulBacon/PurrNet/commit/c116ee73070bc3199b89b0be405df8d5151cd2ae))
* Fixes SyncVar double initialization ([e5766c5](https://github.com/PowerfulBacon/PurrNet/commit/e5766c5fbb7b22e1d365ded40158550eabf4c2f1))
* Minor fixes to the dictionary drawer ([9bbc271](https://github.com/PowerfulBacon/PurrNet/commit/9bbc27107bdbae4bff972250797839071f046069))
* Run the release please ([42fd94d](https://github.com/PowerfulBacon/PurrNet/commit/42fd94d98f8a11784ba26ed20545d6c87f2ff176))


### Continuous Integration

* **release:** 1.0.0 [skip ci] ([c47d6fe](https://github.com/PowerfulBacon/PurrNet/commit/c47d6fe2c98eab464338b0a0122881f39f0fe500))


### Features

* Adds a log for no reason, debugging ([001550e](https://github.com/PowerfulBacon/PurrNet/commit/001550eaf6d77f45cdfea6cbf8c657b256fb106c))
* Adds in a debug view for modules under network identities when PURRNET_DEBUG_NETWORK_IDENTITY is set ([be92375](https://github.com/PowerfulBacon/PurrNet/commit/be9237566d6a3ffab585ed24714fdfcc7943ceda))
* Changes how dictionaries are drawn so they can show complex objects in their contents ([22235b7](https://github.com/PowerfulBacon/PurrNet/commit/22235b72050902722d1651af8bf078c0ccffb1b6))
* RPCs will now be queued if their network module is not available ([31bdc02](https://github.com/PowerfulBacon/PurrNet/commit/31bdc029d49adff8c32636e7a06c9236f6e1df2c))


### Reverts

* Revert "ci(release): 1.0.0 [skip ci]" ([e81b826](https://github.com/PowerfulBacon/PurrNet/commit/e81b826946940d3fff5d34dd490397b7d9dc600e))


### BREAKING CHANGES

* **release:** fixed type in `AuthenticationBehaviour<T>`, renamed `GetClientPlayload` to `GetClientPayload` ([b03e333](https://github.com/PowerfulBacon/PurrNet/commit/b03e333c40c3e637b67806041136c29df4ff3276))
...
* Adds in a debug view for modules under network identities when PURRNET_DEBUG_NETWORK_IDENTITY is set ([289f339](https://github.com/PowerfulBacon/PurrNet/commit/289f33949edde233a8eeb6b61ec824c4a08b5046))
